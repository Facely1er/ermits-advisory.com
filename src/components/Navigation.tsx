          ...
          <Link to="/" className="flex items-center flex-shrink-0 max-w-[45%] md:max-w-none">
            ...
            <div className="ml-0.5 md:ml-3">
              <span className="font-outfit font-semibold text-navy dark:text-white">
                ...
                <span className="block text-[0.22rem] leading-[0.28rem] md:text-[0.6rem] md:leading-tight uppercase tracking-tighter md:tracking-wide font-light opacity-70 md:opacity-90 md:font-normal">
