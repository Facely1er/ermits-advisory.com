      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-100">
            ERMITS Advisory is committed to protecting your privacy and ensuring the security of your personal information. 
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-silver mb-4">
                  As a cybersecurity advisory firm, we understand the critical importance of data protection. 
                  We apply the same rigorous security standards to protecting your personal information that we 
        ...
        >
          <Card variant="glass" padding="lg">
            <h3 className="text-xl font-bold mb-4 dark:text-white">Your Rights and Choices</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold mb-2 dark:text-gray-100">Access and Portability</h4>
                ...
                <h4 className="font-semibold mb-2 dark:text-gray-100">Deletion and Rectification</h4>
                <p className="text-gray-600 dark:text-gray-200 text-sm mb-4">
                  You can request deletion or correction of your personal information, subject to legal requirements.
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-2 dark:text-gray-100">Marketing Communications</h4>
                <p className="text-gray-600 dark:text-gray-200 text-sm mb-4">
                  You can opt-out of marketing communications at any time through unsubscribe links or by contacting us.
                </p>
                
                <h4 className="font-semibold mb-2 dark:text-gray-100">Cookies and Tracking</h4>
                <p className="text-gray-600 dark:text-gray-200 text-sm mb-4">
        ...
        >
          <Card variant="glass" padding="lg">
            <h3 className="text-xl font-bold mb-4 dark:text-white">Contact Us About Privacy</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-200">Within 30 days</p>
                </div>
              </div>
            </div>
          </Card>
